            ...
            <div class="scrol" >
                ...
                <div class="row" id="colo">
                    ...
                    <div class="col">
                        ...
                        <div class="add"><a href="{{url('pvone_one/'.$offe[3])}}"><i class="fa fa-add" style="font-size: 0.9em;"  aria-hidden="true"></i>PV 1</a></div>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="close"><i class="fa fa-close" style="font-size: 0.9em;"  aria-hidden="true"></i> PV 2</div>
                        <div class="add"><a href="{{url('pvtwo_one/'.$offe[3])}}"><i class="fa fa-add" style="font-size: 0.9em;"  aria-hidden="true"></i>PV 2</a></div>
                    </div>
                    <div class="col">
                        <div class="close"><i class="fa fa-close" style="font-size: 0.9em;"  aria-hidden="true"></i>PV 3</div>
                    </div>
                    ...
                    <div class="col">
                        <div class="close"><i class="fa fa-close" style="font-size: 0.9em;"  aria-hidden="true"></i>PV 3</div>
                        <div class="add"><a href="{{url('pvthree_one/'.$offe[3])}}"><i class="fa fa-add" style="font-size: 0.9em;"  aria-hidden="true"></i>PV 3</a></div>
                    </div>
                    @endif
